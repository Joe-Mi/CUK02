...
<body class="page">
    <nav class="navbar">
        ...
        <div class="nav-links" id="navLinks">
            <ul>
                <li><a href="{{ route('home') }}"> <i class="fas fa-home"></i>Overview</a></li>
                <li><a href="{{ route('sponsors') }}"><i class="fas fa-handshake"></i> stats</a></li>
                <li><a href="{{ route('wall') }}"><i class="fas fa-bullseye"></i>attendance</a></li>
                </li>
            </ul>
        </div>
    </nav>
